...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Gallery Management')" class="grid">
                ...
                <flux:navlist.item icon="folder" :href="route('galleryManager.posts.index')" :current="request()->routeIs('galleryManager.posts.index')" wire:navigate>
                    {{ __('All Posts') }}
                </flux:navlist.item>

                <flux:navlist.item icon="document" :href="route('galleryManager.images.index')" :current="request()->routeIs('galleryManager.images.index')" wire:navigate>
                    {{ __('All Images') }}
                </flux:navlist.item>
            </flux:navlist.group>
    ...
    <flux:header>
        ...
        <a href="{{ route('dashboard') }}" class="btn bg-base-100 border"><- वापिस</a>
