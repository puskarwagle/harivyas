<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            ...
            {{-- यूज़र मैनेजर --}}
            <a href="{{ route('usersManager') }}"
                class="block p-6 bg-base-100 border border-neutral-300 rounded-xl hover:shadow-xl transition-all dark:border-neutral-700 group">
            ...
            {{-- पोस्ट बनाएं --}}
            <a href="{{ route('galleryManager.posts.create') }}"
                class="block p-6 bg-base-100 border border-neutral-300 rounded-xl hover:shadow-xl transition-all dark:border-neutral-700 group">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="124" height="124" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- सभी पोस्ट --}}
            <a href="{{ route('galleryManager.images.index') }}"
                class="block p-6 bg-base-100 border border-neutral-300 rounded-xl hover:shadow-xl transition-all dark:border-neutral-700 group">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="124" height="124" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
