    ...
    <div class="p-6">
        ...
        <form wire:submit.prevent="submitPostWithImages">
            ...
            <div class="form-control mb-6">
                <input type="text" wire:model.defer="title" placeholder="Caption" class="input input-bordered input-lg w-full rounded-xl" required />
            ...
            <div class="collapse collapse-arrow bg-base-200 rounded-xl mb-6">
                ...
                <div class="collapse-content space-y-4">
                    ...
                    <div class="form-control">
                        <textarea wire:model.defer="description" placeholder="Description..." class="textarea textarea-bordered rounded-xl resize-none w-full" rows="4"></textarea>
                    ...
                    <div class="form-control">
                        <div class="relative">
                            ...
                            <input type="text" wire:model.defer="location" placeholder="Location" class="input input-bordered rounded-xl pl-10 w-full" />
                        </div>
                    ...
                    <div class="form-control">
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/40 z-10">📅</span>
                            <input type="text" wire:model.defer="year" placeholder="Year" maxlength="10" class="input input-bordered rounded-xl pl-10 w-full" />
                        </div>
                    ...
                    <div class="form-control">
                        ...
                        <div class="join w-full">
                            <input type="text" placeholder="Add tag..." wire:model.defer="newTag" class="input input-bordered join-item flex-1 rounded-l-xl" wire:keydown.enter="addTag" />
                            <button type="button" wire:click="addTag" class="btn btn-primary join-item rounded-r-xl">
                                +
                            </button>
                        </div>
