    ...
    <div x-data="sampradayaPage()" class="min-h-screen">
            ...
            <div x-show="activeTab === 'texts'" x-transition class="space-y-12">
                ...
                <div class="card bg-base-100 shadow-xl border border-info">
                    <div class="card-body">
                        ...
                        <div class="grid lg:grid-cols-2 gap-8">
                            <div class="space-y-6">
                                <div class="card bg-neutral-content shadow-lg">
                                    <div class="card-body">
                                        <h4 class="card-title text-accent">Vedanta kaustubha</h4>
                                        <p class="text-error">
                                            Nimbarkacharya's commentary on the Brahma Sutras, establishing
                                            the philosophical foundation of Dvaitadvaita.
                                        </p>
                                        <div class="badge badge-info">Primary Text</div>
                                    </div>
                                </div>

                                <div class="card bg-neutral-content shadow-lg">
                                    <div class="card-body">
                                        <h4 class="card-title text-accent">Dasha Shloki</h4>
                                        <p class="text-error">
                                            Ten essential verses summarizing the core principles
                                            of Nimbarka philosophy and practice.
                                        </p>
                                        <div class="badge badge-info">Essence</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="card bg-neutral-content shadow-lg">
                                    <div class="card-body">
                                        <h4 class="card-title text-accent">Jugal Satak</h4>
                                        <p class="text-error">
                                            Devotional poetry celebrating the divine pastimes
                                            and qualities of Lord Krishna.
                                        </p>
                                        <div class="badge badge-info">Devotional</div>
                                    </div>
                                </div>

                                <div class="card bg-neutral-content shadow-lg">
                                    <div class="card-body">
                                        <h4 class="card-title text-accent">Mahavani</h4>
                                        <p class="text-error">
            ...
            <div x-show="activeTab === 'centers'" x-transition class="space-y-12">
                            ...
                            <div class="space-y-6">
                                <div class="card bg-primary shadow-lg">
                                    <div class="card-body">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <h4 class="card-title text-accent">Vrindavan, India</h4>
                                        </div>
                                ...
                                <div class="card bg-primary shadow-lg">
                                    <div class="card-body">
                                        <div class="flex items-center mb-3">
                                            <i class="fas fa-map-marker-alt text-error mr-3"></i>
                                            <h4 class="card-title text-accent">Nimbgram, Rajasthan</h4>
                                        </div>
                                        <p class="text-base-content mb-3">
                            ...
                            <div class="space-y-6">
                                <div class="card bg-primary shadow-lg">
                                    <div class="card-body">
                                        <div class="flex items-center mb-3">
                                            <i class="fas fa-map-marker-alt text-error mr-3"></i>
                                            <h4 class="card-title text-accent">Salempet, Telangana</h4>
                                        </div>
                                        <p class="text-base-content mb-3">
                                ...
                                <div class="card bg-primary shadow-lg">
                                    <div class="card-body">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <h4 class="card-title text-accent">International Centers</h4>
                                        </div>
                                        <p class="text-base-content mb-3">
                ...
                <div class="stats stats-vertical lg:stats-horizontal shadow w-full">
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-value text-primary">100,000+</div>
        ...
        <div class="py-16">
            <div class="container mx-auto px-4 text-center">
                <h3 class="text-3xl font-bold text-base-content mb-6">Experience the Living Tradition</h3>
                <p class="text-xl text-primary mb-8 max-w-2xl mx-auto">
