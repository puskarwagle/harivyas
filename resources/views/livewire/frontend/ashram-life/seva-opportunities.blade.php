                    ...
                    <div class="flex justify-center mt-8">
                        <div class="stats stats-horizontal shadow">
                            <div class="stat text-center">
                                ...
                                <div class="stat-desc text-primary">Active Sevaks</div>
                            </div>
                            <div class="stat text-center">
                                <div class="stat-value text-600">15</div>
                                <div class="stat-desc text-primary">Seva Categories</div>
                            </div>
                            <div class="stat text-center">
                                <div class="stat-value text-600">24/7</div>
                                <div class="stat-desc text-primary">Service Hours</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <template x-for="seva in filteredSevas" :key="seva.id">
                    <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-all duration-300">
                        <div class="card-body">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-primary" x-text="seva.subtitle"></p>
                                    </div>
                                </div>
                            ...
                            <!-- Description -->
                            <p class="text-primary mb-4" x-text="seva.description"></p>
                            ...
                            <!-- Benefits -->
                            <div class="mb-4">
                                <h4 class="font-semibold text-base-content mb-2">What you'll gain:</h4>
                ...
                <template x-if="selectedSeva">
                    <div>
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary" x-text="selectedSeva.subtitle"></p>
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            <!-- Full Description -->
                            <div>
                                <h4 class="font-bold text-acccent mb-2">Detailed Description</h4>
                                <p class="text-primary" x-text="selectedSeva.fullDescription"></p>
                            </div>

                            <!-- Responsibilities -->
                            <div>
                                <h4 class="font-bold text-acccent mb-2">Key Responsibilities</h4>
                            ...
                            <!-- Requirements -->
                            <div>
                                <h4 class="font-bold text-acccent mb-2">Requirements</h4>
                                <ul class="list-disc list-inside text-primary space-y-1">
                            ...
                            <!-- Schedule -->
                            <div>
                                <h4 class="font-bold text-acccent mb-2">Schedule & Commitment</h4>
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <p class="text-base-content"><strong>Time:</strong> <span x-text="selectedSeva.timeCommitment"></span></p>
                                    <p class="text-base-content"><strong>Duration:</strong> <span x-text="selectedSeva.duration"></span></p>
                                    <p class="text-base-content"><strong>Flexibility:</strong> <span x-text="selectedSeva.flexibility"></span></p>
                                </div>
                            </div>
                        </div>
            ...
            return {
                ...
                sevas: [{
                    ...
                    , {
                        ...
                        , fullDescription: 'Use your technical skills to serve the mission by developing Mobile Apps, mobile apps, and digital tools that help spread Nimbarka teachings to a global audience.'
                        ...
                        , responsibilities: ['Develop and maintain Mobile Apps', 'Create mobile applications', 'Manage databases and content', 'Provide technical support']
