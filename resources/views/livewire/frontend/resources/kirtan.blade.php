    ...
    <div class="min-h-screen">
        ...
        <div class="hero py-16">
            <div class="hero-content text-center max-w-4xl">
                <div class="w-full">
                    <h1 class="text-5xl font-bold mb-2">कीर्तन</h1>
                    <h2 class="text-2xl font-semibold text-primary mb-8">Divine Kirtan</h2>

                    <!-- Current Playing Card -->
                    <div class="card shadow-xl border border-error-200 mb-8">
                        <div class="card-body">
