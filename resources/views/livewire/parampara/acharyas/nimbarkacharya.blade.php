<div>
    <div x-data="acharyaPage()" class="min-h-screen">
        ...
        <div class="hero bg-gradient-to-br from-base-100 via-base-100 to-base-100 py-20">
            <div class="hero-content flex-col lg:flex-row-reverse max-w-6xl">
                <div class="lg:w-1/2 flex justify-center">
                    <div class="relative">
                        <div class="w-80 h-80 lg:w-96 lg:h-96">
                            <img src="/images/nimbarkacharya.jpg" alt="Acharya Nimbarkacharya" class="w-full h-full object-cover rounded-full shadow-2xl border-8 border-primary" />
                        </div>
                        <div class="absolute -bottom-4 -right-4 bg-primary text-base-100 rounded-full p-4 shadow-lg">
                ...
                <div class="lg:w-1/2 text-center lg:text-left mt-8 lg:mt-0">
                    ...
                    <h1 class="text-5xl lg:text-6xl font-bold text-primary mb-2">निम्बार्काचार्य</h1>
                    <h2 class="text-2xl lg:text-3xl font-semibold text-primary mb-4">Acharya Nimbarkacharya</h2>
                    ...
                    <p class="text-lg text-base-content leading-relaxed max-w-2xl">
        ...
        <div class="container mx-auto px-4 py-12">
            ...
            <div x-show="activeTab === 'biography'" x-transition:enter="transition-opacity duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2">
                        <div class="card bg-base-100 shadow-xl border border-primary">
                            <div class="card-body prose max-w-none">
                                <h3 class="text-2xl font-bold text-primary mb-6">Life and Early Years</h3>
                                <p class="text-base-content leading-relaxed mb-4">
                                ...
                                <h4 class="text-xl font-semibold text-primary mt-8 mb-4">Spiritual Journey</h4>
                                <p class="text-base-content leading-relaxed mb-4">
                                ...
                                <h4 class="text-xl font-semibold text-primary mt-8 mb-4">Divine Mission</h4>
                                <p class="text-base-content leading-relaxed mb-4">
                    ...
                    <div class="space-y-6">
                        <!-- Quick Facts -->
                        <div class="card bg-gradient-to-br from-base-100 to-base-100 shadow-xl border border-primary">
                            <div class="card-body">
                                <h4 class="card-title text-primary mb-4"><i class="fas fa-info-circle mr-2"></i>Quick Facts</h4>
                                <div class="space-y-3">
                        ...
                        <div class="card bg-base-100 shadow-xl border border-primary">
                            <div class="card-body">
                                <h4 class="card-title text-primary mb-4"><i class="fas fa-clock mr-2"></i>Life Timeline</h4>
                                <ul class="timeline timeline-vertical">
                                    <li>
                                        <div class="timeline-start timeline-box bg-base-100 border-primary">
            ...
            <div x-show="activeTab === 'teachings'" x-transition:enter="transition-opacity duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="card bg-base-100 shadow-xl border border-primary">
                        <div class="card-body">
                            <h3 class="card-title text-primary mb-6"><i class="fas fa-yin-yang mr-2"></i>Dvaitadvaita Philosophy</h3>
                            <div class="space-y-4">
                                ...
                                <div class="collapse collapse-arrow bg-base-100 border border-primary">
                                    ...
                                    <div class="collapse-content">
                                        <ol class="list-decimal list-inside space-y-2 text-base-content">
                    ...
                    <div class="card bg-base-100 shadow-xl border border-primary">
                        <div class="card-body">
                            <h3 class="card-title text-primary mb-6"><i class="fas fa-heart mr-2"></i>Path of Bhakti</h3>
                            <div class="space-y-4">
                                <div class="alert alert-base">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="text-center p-4 bg-base-100 rounded-lg border border-primary">
                                        <i class="fas fa-lotus text-primary text-2xl mb-2"></i>
                                        <div class="font-semibold">Sharanagati</div>
                                        <div class="text-sm text-base-content">Complete Surrender</div>
                                    </div>
                                    <div class="text-center p-4 bg-base-100 rounded-lg border border-primary">
                                        <i class="fas fa-music text-primary text-2xl mb-2"></i>
                                        <div class="font-semibold">Kirtan</div>
                                        <div class="text-sm text-base-content">Divine Names</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8">
                    <div class="card bg-base-100 shadow-xl border border-primary">
                        <div class="card-body">
                            <h3 class="card-title text-primary mb-6"><i class="fas fa-quote-left mr-2"></i>Key Teachings</h3>
                            <div class="grid md:grid-cols-2 gap-6">
                                <div class="quote-card bg-gradient-to-br from-base-100 to-base-100 p-6 rounded-lg border border-primary">
                                    <blockquote class="text-base-content italic mb-4">
                                        "The soul is like a spark of the divine fire - different yet inseparable from its source."
                                    </blockquote>
                                    <cite class="text-primary font-semibold">- On Soul-God Relationship</cite>
                                </div>
                                <div class="quote-card bg-gradient-to-br from-base-100 to-base-100 p-6 rounded-lg border border-primary">
                                    <blockquote class="text-base-content italic mb-4">
                                        "True devotion dissolves the ego and reveals the eternal dance of love between Radha and Krishna."
                                    </blockquote>
                                    <cite class="text-primary font-semibold">- On Pure Bhakti</cite>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div x-show="activeTab === 'works'" x-transition:enter="transition-opacity duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2">
                        <div class="card bg-base-100 shadow-xl border border-primary">
                            <div class="card-body">
                                <h3 class="card-title text-primary mb-6"><i class="fas fa-scroll mr-2"></i>Literary Contributions</h3>
                                <div class="space-y-6">
                                    <!-- Work 1 -->
                                    <div class="border-l-4 border-primary pl-6 py-4 bg-base-100 rounded-r-lg">
                                        <h4 class="text-lg font-semibold text-primary mb-2">Vedanta Parijata Saurabha</h4>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <div class="badge badge-outline">Brahma Sutra Commentary</div>
                                    ...
                                    <!-- Work 2 -->
                                    <div class="border-l-4 border-primary pl-6 py-4 bg-base-100 rounded-r-lg">
                                        <h4 class="text-lg font-semibold text-primary mb-2">Dasha Shloki</h4>
                                        <p class="text-base-content mb-3">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <div class="badge badge-outline">Devotional Poetry</div>
                                    ...
                                    <!-- Work 3 -->
                                    <div class="border-l-4 border-primary pl-6 py-4 bg-base-100 rounded-r-lg">
                                        <h4 class="text-lg font-semibold text-primary mb-2">Guru Gita Commentary</h4>
                                        <p class="text-base-content mb-3">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <div class="badge badge-outline">Commentary</div>
                    ...
                    <div class="space-y-6">
                        <div class="card bg-gradient-to-br from-base-100 to-base-100 shadow-xl border border-primary">
                            <div class="card-body">
                                <h4 class="card-title text-primary mb-4"><i class="fas fa-feather-alt mr-2"></i>Writing Style</h4>
                                <ul class="space-y-3">
                                    <li class="flex items-start">
                                        <i class="fas fa-check-circle text-primary mr-2 mt-1"></i>
                                        <span class="text-base-content">Clear logical exposition</span>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-check-circle text-primary mr-2 mt-1"></i>
                                        <span class="text-base-content">Sanskrit scholarship</span>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-check-circle text-primary mr-2 mt-1"></i>
                                        <span class="text-base-content">Devotional depth</span>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-check-circle text-primary mr-2 mt-1"></i>
                                        <span class="text-base-content">Practical guidance</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card bg-base-100 shadow-xl border border-primary">
                            <div class="card-body">
                                <h4 class="card-title text-primary mb-4"><i class="fas fa-download mr-2"></i>Study Resources</h4>
                                <div class="space-y-3">
                                    <button class="btn btn-outline btn-base w-full">
            ...
            <div x-show="activeTab === 'legacy'" x-transition:enter="transition-opacity duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="card bg-base-100 shadow-xl border border-primary">
                        <div class="card-body">
                            <h3 class="card-title text-primary mb-6"><i class="fas fa-university mr-2"></i>Philosophical Legacy</h3>
                            <div class="space-y-4">
                                <p class="text-base-content">
                                ...
                                <div class="stats stats-vertical lg:stats-horizontal shadow bg-base-100">
                                    ...
                                    <div class="stat">
                                        ...
                                        <div class="stat-value text-primary">Continuous</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card bg-base-100 shadow-xl border border-primary">
                        <div class="card-body">
                            <h3 class="card-title text-primary mb-6"><i class="fas fa-users mr-2"></i>Sampradaya Impact</h3>
                            <div class="space-y-4">
                                <p class="text-base-content">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="text-center p-4 bg-base-100 rounded-lg">
                                        ...
                                        <div class="text-sm text-base-content">Worldwide Presence</div>
                                    </div>
                                    <div class="text-center p-4 bg-base-100 rounded-lg">
                                        <i class="fas fa-hands-praying text-primary text-2xl mb-2"></i>
                                        <div class="font-semibold">Living Tradition</div>
                                        <div class="text-sm text-base-content">Active Practice</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8">
                    <div class="card bg-gradient-to-br from-base-100 to-base-100 shadow-xl border border-primary">
                        <div class="card-body">
                            <h3 class="card-title text-primary mb-6"><i class="fas fa-lightbulb mr-2"></i>Contemporary Relevance</h3>
                            <div class="grid md:grid-cols-3 gap-6">
                                <div class="text-center">
                                    <div class="w-16 h-16 bg-base-200 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <i class="fas fa-balance-scale text-primary text-2xl"></i>
                                    </div>
                                    <h4 class="font-semibold text-base-content mb-2">Balanced Approach</h4>
                                ...
                                <div class="text-center">
                                    ...
                                    <h4 class="font-semibold text-base-content mb-2">Devotional Practice</h4>
                                    <p class="text-base-content text-sm">
                                ...
                                <div class="text-center">
                                    <div class="w-16 h-16 bg-base-200 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <i class="fas fa-people-group text-primary text-2xl"></i>
                                    </div>
                                    <h4 class="font-semibold text-base-content mb-2">Community Focus</h4>
                                    <p class="text-base-content text-sm">
        ...
        <div class="bg-gradient-to-r from-base-100 to-base-100 py-12 mt-16">
            <div class="container mx-auto px-4">
                <h3 class="text-2xl font-bold text-primary text-center mb-8">Explore Other Acharyas</h3>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="card bg-base-100 hover:shadow-xl transition-shadow border border-primary">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title justify-center text-primary">Acharya Ramanuja</h4>
                            <p class="text-base-content text-sm">Vishishtadvaita Philosophy</p>
                    ...
                    <div class="card bg-base-100 hover:shadow-xl transition-shadow border border-primary">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title justify-center text-primary">Acharya Madhva</h4>
                            <p class="text-base-content text-sm">Dvaita Philosophy</p>
                            <div class="card-actions justify-center mt-4">
                                <button class="btn btn-outline btn-primary btn-sm">Learn More</button>
                            </div>
                        </div>
                    ...
                    <div class="card bg-base-100 hover:shadow-xl transition-shadow border border-primary">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title justify-center text-primary">Acharya Vallabha</h4>
                            <p class="text-base-content text-sm">Shuddhadvaita Philosophy</p>
                            <div class="card-actions justify-center mt-4">
                                <button class="btn btn-outline btn-primary btn-sm">Learn More</button>
                            </div>
                        </div>
