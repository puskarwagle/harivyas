    ...
    <div x-data="donationForm()" class="min-h-screen">
        ...
        <div class="hero bg-gradient-to-r from-orange-50 to-amber-50 py-16">
            <div class="hero-content text-center">
                <div class="max-w-2xl">
                    <h1 class="text-5xl font-bold text-orange-800 mb-4">दान करें</h1>
                    <h2 class="text-2xl font-semibold text-orange-700 mb-4">Support Our Mission</h2>
                    <p class="text-lg text-gray-600 mb-6">Your generous contribution helps us preserve ancient wisdom, serve devotees, and spread the teachings of Nimbarka Sampradaya</p>
                    <div class="stats shadow bg-white border border-orange-100">
                        <div class="stat">
                            <div class="stat-title text-orange-600">This Month</div>
                            <div class="stat-value text-orange-800">₹2,45,000</div>
                            <div class="stat-desc text-green-600">↗︎ 12% from last month</div>
                        </div>
                        <div class="stat">
                            <div class="stat-title text-orange-600">Devotees Helped</div>
                            <div class="stat-value text-orange-800">1,200+</div>
                            <div class="stat-desc text-green-600">Growing daily</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4 py-12">
            <h3 class="text-3xl font-bold text-center text-orange-800 mb-12">Choose Your Contribution</h3>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-heart text-orange-500 text-3xl mr-4"></i>
                            <h4 class="card-title text-orange-800">General Fund</h4>
                        </div>
                        <p class="text-gray-600 mb-6">Support daily operations, maintenance, and general ashram needs</p>
                ...
                <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-building text-orange-500 text-3xl mr-4"></i>
                            <h4 class="card-title text-orange-800">Temple Construction</h4>
                        </div>
                        <p class="text-gray-600 mb-4">Help build and expand our sacred spaces</p>
                        <div class="mb-6">
                ...
                <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-utensils text-orange-500 text-3xl mr-4"></i>
                            <h4 class="card-title text-orange-800">Prasadam Seva</h4>
                        </div>
                        <p class="text-gray-600 mb-6">Sponsor daily meals and prasadam distribution</p>
                        <div class="flex flex-wrap gap-2 mb-6">
                ...
                <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-book text-orange-500 text-3xl mr-4"></i>
                            <h4 class="card-title text-orange-800">Education & Books</h4>
                        </div>
                        <p class="text-gray-600 mb-6">Support publication of scriptures and educational programs</p>
                        <div class="flex flex-wrap gap-2 mb-6">
                ...
                <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-calendar-alt text-orange-500 text-3xl mr-4"></i>
                            <h4 class="card-title text-orange-800">Festival Sponsorship</h4>
                        </div>
                        <p class="text-gray-600 mb-6">Sponsor festivals and special celebrations</p>
                        <div class="flex flex-wrap gap-2 mb-6">
                ...
                <div class="card bg-base-100 shadow-xl border border-orange-100 hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-calendar-check text-orange-500 text-3xl mr-4"></i>
                            <h4 class="card-title text-orange-800">Monthly Support</h4>
                        </div>
                        <p class="text-gray-600 mb-6">Become a regular supporter with monthly contributions</p>
                        <div class="flex flex-wrap gap-2 mb-6">
            ...
            <!-- Bank Details -->
            <div class="card bg-base-100 shadow-xl border border-orange-100 mb-12">
                <div class="card-body">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-4">Indian Bank Account</h4>
                            <div class="space-y-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-4">UPI & Digital Payments</h4>
                            <div class="space-y-4">
                                <div>
                                    <span class="text-gray-600">UPI ID:</span>
                                    <div class="flex items-center mt-2">
                                        <span class="font-mono bg-gray-100 px-3 py-2 rounded mr-2">harinikunj@upi</span>
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="text-sm text-gray-600 mt-2">Scan to donate via UPI</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Donation Modal -->
        <div x-show="showModal" x-transition class="modal modal-open">
            <div class="modal-box max-w-2xl">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="font-bold text-2xl text-orange-800" x-text="modalTitle"></h3>
